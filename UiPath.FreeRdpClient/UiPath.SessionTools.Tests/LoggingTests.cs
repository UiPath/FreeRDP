...
public class LoggingTests
{
    ...
    => FormatRunStarted("{fileName}", "{arguments}").ShouldBe(RunStarted);
    ...
    => FormatRunSucceeded("{fileName}", "{arguments}", "{stdout}", "{stderr}").ShouldBe(RunSucceeded);
    ...
    => FormatRunFailed("{fileName}", "{arguments}", "{exitCode}", "{stdout}", "{stderr}").ShouldBe(RunFailed);
    ...
    => FormatRunWaitCanceled("{fileName}", "{arguments}", "{stdout}", "{stderr}").ShouldBe(RunWaitCanceled);
}
